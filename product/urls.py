...
urlpatterns = [
    ...
    path('updateSize/<int:product_id>',
         views.updateProductSize, name='updateSize'),
    path('new_banner', views.new_banner, name="newBanner"),
    path('amendbanners', views.amend_banner, name='amendbanners'),
    path('updatebanner/int<banner_id>',
         views.update_banner, name='updatebanner'),
    path('deletebanner/<int:banner_id>',
         views.delete_banner, name='deletebanner'),
    ...
    path('product_review/<int:product_id>/',
         views.product_review, name='productreview'),
]
